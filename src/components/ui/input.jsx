    ...
    <div className="relative w-full">
      ...
      <div className="relative">
        ...
        <input
          ...
          required={required}
          className={cn(
            "w-full rounded-xl border !pr-9 px-4 py-2 text-primary-dark bg-background-default focus:ring-2 focus:ring-primary-default focus:outline-none transition-all duration-300 ease-in-out",
